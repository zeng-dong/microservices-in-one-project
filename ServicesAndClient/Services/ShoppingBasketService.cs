...
{
    public class ShoppingBasketServiceForWebClient : IShoppingBasketServiceForWebClient
    {
        private readonly HttpClient client;
        private readonly Settings settings;

        public ShoppingBasketServiceForWebClient(HttpClient client, Settings settings)
        {
            this.client = client;
